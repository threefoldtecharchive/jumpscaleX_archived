...
class BuilderFreeflow(j.builder.system._BaseClass):
    ...
    def install(self, reset =False,humhub_version = '1.3.13'):
        ...
        j.builder.tools.file_download("https://www.humhub.org/en/download/package/humhub-{0}.tar.gz".format(self.HUMHUB_VERSION),"/var/www/html/humhub-{0}.tar.gz".format(self.HUMHUB_VERSION))
        j.builder.tools.file_expand("/var/www/html/humhub-{0}.tar.gz".format(self.HUMHUB_VERSION), self.HUMHUB_PATH, removeTopDir=True)
