...
class TestCases(BaseTest):
    ...
    def test001_caddy(self):
        j.builders.web.caddy.sandbox(zhub_instance=self.hub_instance, reset=True, create_flist=True)
    ...
    def test002_traefik(self):
        j.builders.web.traefik.sandbox(zhub_instance=self.hub_instance, reset=True, create_flist=True)
    ...
    def test003_nginx(self):
        j.builders.web.nginx.sandbox(zhub_instance=self.hub_instance, reset=True, create_flist=True)
    ...
    def test005_openresty(self):
        j.builders.web.openresty.sandbox(zhub_instance=self.hub_instance, reset=True, create_flist=True)
    ...
    def test006_etcd(self):
        j.builders.db.etcd.sandbox(zhub_instance=self.hub_instance, reset=True, create_flist=True)
    ...
    def test007_coredns(self):
        j.builders.network.coredns.sandbox(zhub_instance=self.hub_instance, reset=True, create_flist=True)
