...
class Storage_TestCases(BaseTest):
    ...
    @parameterized.expand([("minio", "minio"), ("syncthing", "syncthing")])
    def test_storage_builders(self, builder, process):
        """ BLD-001
        *Test db builers sandbox*
        """
        skipped_builders = {"minio": "https://github.com/threefoldtech/jumpscaleX/issues/657"}
