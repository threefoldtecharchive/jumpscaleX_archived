...
from Jumpscale.clients.blockchain.tfchain.types.FulfillmentTypes import FulfillmentSingleSignature, FulfillmentMultiSignature
...
def main(self):
    ...
    explorer_client.mint_condition_add(
        condition=j.clients.tfchain.types.conditions.from_recipient('01a006599af1155f43d687635e9680650003a6c506934996b90ae84d07648927414046f9f0e936'),
        height=0,
    )
    ...
    explorer_client.mint_condition_add(
        condition=j.clients.tfchain.types.conditions.from_recipient('014ad318772a09de75fb62f084a33188a7f6fb5e7b68c0ed85a5f90fe11246386b7e6fe97a5a6a'),
        height=3643,
    )
    ...
    # set another mint condition manually
    explorer_client.mint_condition_add(
        condition=j.clients.tfchain.types.conditions.from_recipient('011cf61451b58970eeead00819e33f7fc812bd9b2d4e66914efa6163e238752d34be252ac8667f'),
        height=3645,
    )
