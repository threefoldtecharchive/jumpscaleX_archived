...
def main(self):
    ...
    js_shell 'j.clients.tfchain.test(name="atomicswap_verify_receiver")'
    """
    ...
    w.atomicswap.verify('dd1babcbab492c742983b887a7408742ad0054ec8586541dd6ee6202877cb486', min_duration='1d12h')
    # which will fail if assumed wrong
    with pytest.raises(AtomicSwapContractInvalid):
        w.atomicswap.verify('dd1babcbab492c742983b887a7408742ad0054ec8586541dd6ee6202877cb486', min_duration='2d')
    ...
    w.atomicswap.verify('dd1babcbab492c742983b887a7408742ad0054ec8586541dd6ee6202877cb486',
            amount=50, secret_hash='e24b6b609b351a958982ba91de7624d3503f428620f5586fbea1f71807b545c1',
            min_duration='1d', receiver=True, contract=contract)
