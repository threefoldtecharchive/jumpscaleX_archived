...
def main(self):
    ...
    w.atomicswap.verify('023b1c17a01945573933e62ca7a1297057681622aaea52c4c4e198077a263890', min_duration='1d')
    # which will fail if assumed wrong
    with pytest.raises(AtomicSwapContractInvalid):
        w.atomicswap.verify('023b1c17a01945573933e62ca7a1297057681622aaea52c4c4e198077a263890', min_duration=0)
    ...
    w.atomicswap.verify('023b1c17a01945573933e62ca7a1297057681622aaea52c4c4e198077a263890',
        ...
        min_duration='1d', sender=True)

    # once the refund time has been reached, it does become refundable, and min_duration=0 should validate correctly
