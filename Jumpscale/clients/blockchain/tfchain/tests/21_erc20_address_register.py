...
def main(self):
    ...
    expected_transaction = {
        "version": 210,
        "data": {
            "pubkey": "ed25519:bdea9aff09bcdc66529f6e2ef1bb763a3bab83ce542e8673d97aeaed0581ad97",
    ...
    result = w.erc20.address_register(
        value="014ad318772a09de75fb62f084a33188a7f6fb5e7b68c0ed85a5f90fe11246386b7e6fe97a5a6a"
    )
    assert result.submitted  # it is expected the transaction is submitted, as we do not use Multi-Sig coin inputs
    ...
    expected_transaction = {
        "version": 210,
        "data": {
            "pubkey": "ed25519:64ae81a176302ea9ea47ec673f105da7a25e52bdf0cbb5b63d49fc2c69ed2eaa",
            "tftaddress": "014ad318772a09de75fb62f084a33188a7f6fb5e7b68c0ed85a5f90fe11246386b7e6fe97a5a6a",
            "erc20address": "0x3001cb4e707f6389e55cc714a3b5e42e1b7a12d5",
            "signature": "59d530c71cb1f6bba142c5aadb047abdda236f67b70238253267e55f4f7bb10f1b9cc4e2715612cc6e0e5e50634527c1964030554c37a9a53e0df613d15f930e",
            "regfee": "10000000000",
            "txfee": "1000000000",
            "coininputs": [
                {
    ...
    with pytest.raises(j.clients.tfchain.errors.ERC20RegistrationForbidden):
        result = w.erc20.address_register(
            value="015a080a9259b9d4aaa550e2156f49b1a79a64c7ea463d810d4493e8242e6791584fbdac553e6f"
        )
    ...
    expected_transaction = {
        "version": 210,
        "data": {
            "pubkey": "ed25519:052007f06e3b88dcb3d44931ebf7a1c7973438e97a0a73f2407677dab88b3a6f",
            "tftaddress": "01056f56a2e59a67334b697926af7e5a93c487aa5d54bbd48d0652092548c54073ea4ee1bd7d1b",
            "erc20address": "0xa811dc6f5612cc89e2e23fbcf70994deb42ccfc3",
    ...
    assert w.addresses == [
        "014ad318772a09de75fb62f084a33188a7f6fb5e7b68c0ed85a5f90fe11246386b7e6fe97a5a6a",
        "018f5a43327fb865843808ddf549f1b1c06376e07195423778751056be626841f42dcf25a593fd",
        "01056f56a2e59a67334b697926af7e5a93c487aa5d54bbd48d0652092548c54073ea4ee1bd7d1b",
    ]
