...
class TFChainCapacity:
    ...
    def reserve_s3(self, email, threebot_id, location, size=1, source=None, refund=None):
        ...
        reservation = j.data.schema.get(url="tfchain.reservation.s3").new(
    ...
    def reserve_zos_vm(self, email, threebot_id, location, size=1, source=None, refund=None):
        ...
        :rtype: tuple
        """
        reservation = j.data.schema.get(url="tfchain.reservation.zos_vm").new(
    ...
    def reserve_zdb_namespace(
        ...
        :rtype: tuple
        """
        reservation = j.data.schema.get(url="tfchain.reservation.zdb_namespace").new(
            data={
                "type": "namespace",
                "size": size,
                "email": email,
    ...
    def reserve_reverse_proxy(self, email, threebot_id, domain, backend_urls, source=None, refund=None):
        ...
        :rtype: tuple
        """
        reservation = j.data.schema.get(url="tfchain.reservation.reverse_proxy").new(
            data={
                "type": "reverse_proxy",
                "email": email,
                "created": j.data.time.epoch,
