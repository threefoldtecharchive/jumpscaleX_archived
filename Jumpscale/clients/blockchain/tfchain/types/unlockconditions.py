...
DO NOT USE THROUGH IMPORTS ONLY USE FROM TYPES FACTORY !!!

use from j.clients.tfchain.types.condition_...._get()
...
class AtomicSwapFulfillment(BaseFulFillment):
    ...
    #TODO: should this be accessible from types factory?
    """
