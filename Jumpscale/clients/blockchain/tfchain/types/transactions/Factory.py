...
class TransactionFactory(j.application.JSBaseClass):
    ...
    def test(self):
        ...
        v144_txn_json = {
            ...
            "data": {
                ...
                "coininputs": [
                    {
                        ...
                        "fulfillment": {
                            ...
                            "data": {
                                "publickey": "ed25519:d285f92d6d449d9abb27f4c6cf82713cec0696d62b8c123f1627e054dc6d7780",
                                "signature": "909a7df820ec3cee1c99bd2c297b938f830da891439ef7d78452e29efb0c7e593683274c356f72d3b627c2954a24b2bc2276fed47b24cd62816c540c88f13d05",
                            },
                        },
                    }
                ],
                ...
                "identification": {
                    ...
                    "signature": "98e71668dfe7726a357039d7c0e871b6c0ca8fa49dc1fcdccb5f23f5f0a5cab95cfcfd72a9fd2c5045ba899ecb0207ff01125a0151f3e35e3c6e13a7538b340a",
                },
            },
        }
        ...
        assert (
            v144_txn.signature_hash_get(BotTransactionBaseClass.SPECIFIER_SENDER).hex()
            == "f9204641c6a945af6d262154f3d1dfa82aa291c4fc4000936ee72fc3506cfd2c"
        )
        assert (
            v144_txn.binary_encode().hex()
            == ""
        )
        ...
        v145_txn_json = {
            ...
            "data": {
                "id": 3,
                "addresses": {"add": ["example.com", "127.0.0.1"], "remove": ["example.org"]},
                "names": {"add": ["giveme.yourfeedback", "thisis.anexample"], "remove": ["chatbot.example"]},
                "nrofmonths": 4,
                "txfee": "1000000000",
                "coininputs": [
                    {
                        "parentid": "81a0c1f3094b99b0858da8ebc95b52f2c3593ea399d7b72a66a930521aae61bb",
                        "fulfillment": {
                            "type": 1,
                            "data": {
                                "publickey": "ed25519:880ee50bd7efa4c8b2b5949688a09818a652727fd3c0cb406013be442df68b34",
                                "signature": "d612b679377298e6ccb8a877f7a129d34c65b8850cff1806b9f62d392b6ab173020c3698658275c748047642f8012a4ac75ea23e319bcc405c9d7f2b462b6a0b",
                            },
                        },
                    }
                ],
                "refundcoinoutput": {
                    "value": "99998737000000000",
                    "condition": {
                        "type": 1,
                        "data": {
                            "unlockhash": "01972837ee396f22f96846a0c700f9cf7c8fa83ab4110da91a1c7d02f94f28ff03e45f1470df82"
                        },
                    },
                },
                "signature": "f76e7ed808a9efe405804109d5e3c8695daf8b9bc7abf1e471fef94b3c4d36789b460f9e45cdf27d83d270b0836fef56bd499e1be8e1f279d367e961bbe62f03",
            },
        }
        v145_txn = self.from_json(v145_txn_json)
        assert v145_txn.json() == v145_txn_json
        assert (
            v145_txn.signature_hash_get(BotTransactionBaseClass.SPECIFIER_SENDER).hex()
            == "3d86ed117c97718a9d0d644188e019b4fa55ec22f2c32c187d223d4e73a1ab72"
        )
        assert (
            v145_txn.binary_encode().hex()
            == ""
        )
        # ensure no constants are mutated
        ...
        v146_txn_json = {
            ...
            "data": {
                "sender": {
                    "id": 1,
                    "signature": "f1c6109c685c7452efaf20cec6b170817f1faeb6f0a4ff49a7a0872343e62810f51dee051d8eb7883fb0ad7a848aa5bf18b8bd30fe109daa04f13e7d76af750a",
                },
                "receiver": {
                    "id": 2,
                    "signature": "ae9dc9fa308e76de123b5f889fed93d6d9a701dc8d5369787dc25095f3d6eb833f6d47302697d2da22e05854d08f26d723463f328cc6ec445529cff583903308",
                },
                "names": ["hello.threebot"],
                "txfee": "1000000000",
                "coininputs": [
                    {
                        "parentid": "572635ceed12c61cd78e97391c75fefb01cc969211aa827de4c44eb66285a37c",
                        "fulfillment": {
                            "type": 1,
                            "data": {
                                "publickey": "ed25519:3079d97d169f96b996ff87677483bb601150c1bae8b1061ecbb137b9597d7cb9",
                ...
                "refundcoinoutput": {
                    "value": "99993832000000000",
                    "condition": {
                        "type": 1,
                        "data": {
                            "unlockhash": "014195d5ada0434d0766bf9e3d9b87d2f63ef7b1820739cff88335d45cbae2dac58ec00841c570"
                        },
                    },
                },
            },
        ...
        assert (
            v146_txn.signature_hash_get(BotTransactionBaseClass.SPECIFIER_SENDER).hex()
            == "ade263bfbc693e95463f19c201dd672bbd2616412362217c70317dfb42ab73cb"
        )
        assert (
            v146_txn.signature_hash_get(BotTransactionBaseClass.SPECIFIER_RECEIVER).hex()
            == "36445975184c68e13f8b74e2e87dd72f23cb47ff3bd4f22e80c4654ec63015d9"
        )
        assert (
            v146_txn.binary_encode().hex()
            == ""
        )
        # ensure no constants are mutated
        assert BotTransactionBaseClass.BOT_FEE_ADDITIONAL_NAME == 50
        ...
        v146_txn_json = {
            "version": 146,
            "data": {
                "sender": {"id": 3, "signature": ""},
                "receiver": {"id": 4, "signature": ""},
                "names": ["foobar", "thisis.justan.example"],
                "txfee": "1000000000",
                "coininputs": [
                    {
                        "parentid": "825eecc33a194e087c7d6f711cae384c1b0f7515f3aa3feb590fd04fd1f22613",
                        "fulfillment": {
                            "type": 1,
                            "data": {
                ...
                "refundcoinoutput": {
                    ...
                    "condition": {
                        "type": 1,
                        "data": {
                            "unlockhash": "01b73c4e869b6167abe6180ebe7a907f56e0357b4a2f65eb53d22baad84650eb62fce66ba036d0"
                        },
                    },
                },
            },
        ...
        assert (
            v146_txn.signature_hash_get(BotTransactionBaseClass.SPECIFIER_SENDER).hex()
            == "0e9cac3de589d283b2f25b59eaf4d4797028f14bc3a5f188180e9214311e624f"
        )
        assert (
            v146_txn.signature_hash_get(BotTransactionBaseClass.SPECIFIER_RECEIVER).hex()
            == "74d949499a0c76e09c642b879c7f7b2da7ba047a2adcad477d7211e67be5d031"
        )
        ...
        v208_txn_json = {
            "version": 208,
            "data": {
                "address": "0x1255abe9f2bf09f8e6c748e3819ac9f2dbf843c4",
                "value": "200000000000",
                "txfee": "1000000000",
                "coininputs": [
                    {
        ...
        assert (
            v208_txn.signature_hash_get(0).hex() == "c7b48b96e24b73a341903b1bb2e838ae7abb969ec645e55241e51d6379da3763"
        )
        assert (
            v208_txn.signature_hash_get(1).hex() == "09dd543df119633addb9ed6753924b451dc498d2ad958476eeae9c70841b2839"
        )
        assert (
            v208_txn.binary_encode().hex()
            == ""
        )
        # the coin outputs contains the refund coin output
        assert len(v208_txn.coin_outputs) == 1
        assert (
            v208_txn.coin_outputs[0].condition.unlockhash
            == "011c17aaf2d54f63644f9ce91c06ff984182483d1b943e96b5e77cc36fdb887c846b60460bceb0"
        )
        ...
        v209_txn_json = {
            ...
            "data": {
                ...
                "value": "100000000000",
                "txfee": "1000000000",
                "blockid": "0xf3c001075d527bea48f087cbfaa7c4950beaf9a2ad66bf787760d751c7bcf6bd",
                "txid": "0x3322e1d8cc985cc4f26ace9e4468612c50a05516161a3362c941955d34f91c85",
            },
        }
        v209_txn = self.from_json(v209_txn_json)
        assert v209_txn.json() == v209_txn_json
        assert (
            v209_txn.signature_hash_get(42).hex() == "dacb89c4b44d542e415d517f745ce51f56dab76d1062fa6da691b9a9fa8efa11"
        )
        assert (
            v209_txn.binary_encode().hex()
            == "d101f68299b26a89efdb4351a61c3a062321d23edbc1399c8499947c1313375609ad0a174876e800083b9aca00f3c001075d527bea48f087cbfaa7c4950beaf9a2ad66bf787760d751c7bcf6bd3322e1d8cc985cc4f26ace9e4468612c50a05516161a3362c941955d34f91c85"
        )
        # the coin outputs contains the received value
        assert len(v209_txn.coin_outputs) == 1
        assert (
            v209_txn.coin_outputs[0].condition.unlockhash
            == "01f68299b26a89efdb4351a61c3a062321d23edbc1399c8499947c1313375609adbbcd3977363c"
        )
        ...
        assert (
            v210_txn.signature_hash_get(0).hex() == "d6ccdb92956034f981182f5a311c84b45b01c30967327aaf9847b6fc04ba5e14"
        )
        assert (
            v210_txn.signature_hash_get(1).hex() == "d7172f55e756232bb38b11a47466062f3b26330d87d291c7049658fedb819cca"
        )
        assert (
            v210_txn.binary_encode().hex()
        ...
        assert (
            v210_txn.coin_outputs[0].condition.unlockhash
            == "01370af706b547dd4e562a047e6265d7e7750771f9bff633b1a12dbd59b11712c6ef65edb1690d"
        )
