...
TODO: HOW IS THIS DIFFERENT THAN j.clients.tfchain.types.condition_unlockhash_get()

please document so its clear
...
class UnlockHash:
    ...
    def binary(self):
        ...
        result.extend(binary.encode(self._hash)) #TODO: is on in j.data.rivine...
        return result
