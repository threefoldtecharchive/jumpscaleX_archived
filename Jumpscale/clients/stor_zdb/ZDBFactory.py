...
class ZDBFactory(j.application.JSBaseClass):
    ...
    def client_get(self, nsname="test", addr="localhost", port=9900, secret="1234", mode="seq", **kwargs):
        """
    ...
    def testdb_server_start_client_get(self, reset=False, admin_secret="123456", namespaces_secret="1234"):
        ...
        return j.servers.zdb.start_test_instance(
            destroydata=reset, admin_secret=admin_secret, namespaces_secret=namespaces_secret
        )
