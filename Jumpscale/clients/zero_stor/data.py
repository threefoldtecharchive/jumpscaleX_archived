...
class Data:
    ...
    def write(self, data):
        ...
        :return: chunks
        """
        return self._stub.Write(model.DataWriteRequest(data=data)).chunks
    ...
    def read(self, chunks):
        ...
        :return: data (bytes)
        """
        return self._stub.Read(model.DataReadRequest(chunks=chunks)).data
    ...
    def write_file(self, file_path):
        ...
        return self._stub.WriteFile(model.DataWriteFileRequest(filePath=file_path)).chunks
    ...
    def write_stream(self, input, block_size=4096):
        ...
        def stream():
            while True:
                ...
                if len(chunk) == 0:
                    break
                yield model.DataWriteStreamRequest(dataChunk=chunk)
    ...
    def read_stream(self, chunks, output, chunk_size=4096):
        ...
        response = self._stub.ReadStream(model.DataReadStreamRequest(chunks=chunks, chunkSize=chunk_size))
    ...
    def delete(self, chunks):
        ...
        return self._stub.Delete(model.DataDeleteRequest(chunks=chunks))
    ...
    def check(self, chunks, fast=True):
        ...
        """
        return self._stub.Check(model.DataCheckRequest(chunks=chunks, fast=fast)).status
    ...
    def repair(self, chunks):
        ...
        return self._stub.Repair(model.DataRepairRequest(chunks=chunks)).chunks
