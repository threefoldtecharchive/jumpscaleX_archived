...
def add_FileServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("schema.FileService", rpc_method_handlers)
...
def add_MetadataServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("schema.MetadataService", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
def add_DataServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("schema.DataService", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
