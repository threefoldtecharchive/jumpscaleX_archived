...
class BuilderVolumeDriver(j.builder.system._BaseClass):
    ...
    def _build(self, version='6.0.0'):
        ...
        j.builder.core.dir_ensure(workspace)
        ...
        j.builder.core.file_link(str_repl['buildtools'], j.sal.fs.joinPaths(workspace, 'volumedriver-buildtools'))
        j.builder.core.file_link(str_repl['volumedriver'], j.sal.fs.joinPaths(workspace, 'volumedriver'))
        ...
        j.builder.core.file_copy('{DIR_TEMP}/volumedriver-workspace/volumedriver/build/bin/*', '{DIR_BIN}')
