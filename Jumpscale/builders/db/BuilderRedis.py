...
class BuilderRedis(j.builder.system._BaseClass):
    ...
    def build(self, reset=False, start=False):
        ...
        if j.builder.core.isUbuntu:
            ...
            j.builder.core.dir_remove("{DIR_TEMP}/build/redis")
    ...
    def isInstalled(self):
        return j.builder.core.command_check('redis-server') and j.builder.core.command_check('redis-cli')
    ...
    def start(self, name="main", ip="localhost", port=6379, max_ram="50mb", append_only=True,
        ...
        if unixsocket is not None:
            ...
            j.builder.core.dir_ensure(redis_socket)
    ...
    def configure_instance(self, name, ip="localhost", port=6379, max_ram="1048576", append_only=True,
        ...
        config = config.replace(
            "{DIR_VAR}", j.builder.core.dir_paths["VARDIR"])

        base_dir = j.builder.core.replace(
            '{DIR_VAR}/data/redis/redis_%s' % name)
        j.builder.core.dir_ensure(base_dir)
        ...
        j.builder.core.dir_ensure(db_path)
