...
class BuilderPHP(j.builder.system._BaseClass):
    ...
    def build(self, **config):
        ...
        compileconfig['with_apxs2'] = j.builder.core.replace("{DIR_BASE}/apps/apache2/bin/apxs")
        ...
        if not j.builder.core.file_exists(apxs):
    ...
    def install(self, start=False):
        ...
        # FOR APACHE
        j.builder.core.dir_ensure('{DIR_BASE}/apps/php/lib/')
        j.builder.core.file_copy("{DIR_TEMP}/php/php.ini-development", "{DIR_BASE}/apps/php/lib/php.ini")
        if start:
            self.start()
