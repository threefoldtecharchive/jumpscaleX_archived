...
class BuilderTFChain(j.builder.system._BaseClass):
    ...
    def install(self, branch=None,tag=None, revision=None, reset=False):
        ...
        tfchaindpath = j.builder.core.joinpaths(j.builder.runtimes.golang.GOPATH, 'bin', 'tfchaind')
        tfchaincpath = j.builder.core.joinpaths(j.builder.runtimes.golang.GOPATH, 'bin', 'tfchainc')
