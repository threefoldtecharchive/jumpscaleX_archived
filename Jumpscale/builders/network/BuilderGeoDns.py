...
class BuilderGeoDns(j.builder.system._BaseClass):
    ...
    def install(self, reset=False):
        ...
        j.builder.core.file_copy("{DIR_BASE}/go/bin/geodns", "{DIR_BIN}")
        j.builder.core.dir_ensure("{DIR_VAR}/templates/cfg/geodns/dns", recursive=True)
    ...
    def start(self, ip="0.0.0.0", port="5053", config_dir="{DIR_BASE}/cfg/geodns/dns/",
        ...
        """
        if j.builder.core.dir_exists(config_dir):
            j.builder.core.dir_ensure(config_dir)
