...
class GrafanaFactory(j.application.JSFactoryBaseClass):
    ...
    GrafanaServer = GrafanaComponent
    ...
    def get(self,name,**kwargs):
        """
        use config manager to return server instance specified by the name

        :param name:
        :param kwargs: allows generic usable arguments to be passed to Server e.g. port=...,addr=...
        :return:
        """
        s = self.GrafanaComponent(name=name)
    ...
    def test(self):
        ...
        js_shell 'j.builders._template.test()'
