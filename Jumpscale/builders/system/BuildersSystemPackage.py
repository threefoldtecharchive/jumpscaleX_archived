...
class BuilderSystemPackage(j.builder.system._BaseClass):
    ...
    #     elif j.builder.core.isAlpine:
    #         j.builder.core.run("apk update")
    #         j.builder.core.run("apk upgrade")
    #     else:
    ...
    def mdupdate(self, reset=False):
        ...
        if j.builder.core.isUbuntu:
            ...
            location = j.builder.core.command_location("brew")
    ...
    def start(self, package):
        if j.builder.core.isArch or j.builder.core.isUbuntu or j.core.platformtype.myplatform.isMac:
