...
class BuilderWordpress(j.builder.system._BaseClass):
    ...
    def build(self, reset=False):
        ...
        j.builder.core.file_download(url=url, to=cli_path, overwrite=True, retry=3, timeout=0, removeTopDir=False)
    ...
    def install(self, path, url, title, admin_user, admin_password, admin_email, 
        ...
        j.builder.core.dir_ensure(path)
    ...
    def download_backup(self, path, cfg_path='/opt/cfg', dbname='wordpress'):
        ...
        j.builder.core.dir_ensure(backup_path)
        # export database
        j.builder.db.mariadb.db_export(dbname, backup_path)
        # get wordpress files
        j.builder.core.dir_ensure(backup_path + path)
        j.builder.core.copyTree(path, backup_path + path)
        # get get cfgs
        j.builder.core.dir_ensure(backup_path + cfg_path)
        j.builder.core.copyTree(cfg_path, backup_path + cfg_path)
        ...
        # clean up
        j.builder.core.dir_remove(backup_path)
