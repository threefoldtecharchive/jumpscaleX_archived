...
class BuilderGitea(j.builder.system._BaseClass):
    ...
    def build(self, reset=False):
        ...
        if not j.builder.core.file_is_link(self.CUSTOM_PATH):
            j.builder.core.dir_remove(self.CUSTOM_PATH)

        j.builder.core.file_link(source='/opt/code/github/incubaid/gitea-custom',
