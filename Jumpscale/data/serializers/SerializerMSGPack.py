...
class SerializerMSGPack(SerializerBase):
    ...
    def dumps(self, obj):
        try:
            ...
            raise j.exceptions.Value("Cannot dump (package) msgpack", data=obj, original_exception=e)
    ...
    def loads(self, s):
        if isinstance(s, (bytes, bytearray)):
            try:
                ...
                raise j.exceptions.Value("Cannot dump (package) msgpack", data=s, original_exception=e)
        else:
