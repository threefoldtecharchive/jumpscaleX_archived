...
class group_servers(JSGroup):
    ...
    def redis_logger(self):
        if self._redis_logger is None:
            # print("LOAD:RedisLoggingServer")
            from Jumpscale.servers.redis.RedisServer import RedisLoggingServer
            # try:
            #     from Jumpscale.servers.redis.RedisServer import RedisLoggingServer
            # except Exception as e:
            #     msg = j.core.application.error_init("import", "Jumpscale.servers.redis.RedisServer", e)
            #     raise e
            # # print("RUN:RedisLoggingServer")
            ...
            #     self._redis_logger =  RedisLoggingServer()
            # except Exception as e:
            #     msg = j.core.application.error_init("execute","Jumpscale.servers.redis.RedisServer",e)
            #     return None
            # print("OK")
...
class group_builder(JSGroup):
    ...
    def storage(self):
        if self._storage is None:
            ...
            #     from Jumpscale.builder.storage.BuilderStorageFactory import BuilderAppsFactory
            # except Exception as e:
            #     msg = j.core.application.error_init("import", "Jumpscale.builder.storage.BuilderStorageFactory", e)
            #     raise e
            ...
            #     self._storage =  BuilderAppsFactory()
            # except Exception as e:
            #     msg = j.core.application.error_init("execute","Jumpscale.builder.storage.BuilderStorageFactory",e)
            #     return None
            # print("OK")
