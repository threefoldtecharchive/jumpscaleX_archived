...
class group_tools(JSGroup):
    ...
    @property
    def gridhealth(self):
        if self._gridhealth is None:
            from Jumpscale.tools.grid_health.GridHealthTool import GridHealthFactory

            self._gridhealth = GridHealthFactory()
        return self._gridhealth
